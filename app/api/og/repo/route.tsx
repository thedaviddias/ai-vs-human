...
export async function GET(request: Request) {
  try {
    ...
    logger.info("OG repo square mode selected", {
      owner,
      name,
        ...
        >
          ...
          >
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              >
                <div
                  style={{ display: "flex", fontSize: "32px", color: "#737373", fontWeight: 500 }}
                >
                  {owner} /
                </div>
                <div
    ...
    try {
      ...
      if (selectedSquareMode === "split") {
        logger.warn("OG repo split rendering failed, retrying with blend", {
          owner,
          name,
          requestedMode: requestedSquareMode,
          complexity,
