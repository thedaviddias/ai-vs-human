...
describe("classifyCommit", () => {
  ...
  describe("Level 5: Co-Authored-By AI detection", () => {
    ...
    it("classifies Pi co-author as ai-assisted", () => {
      const result = classifyCommit(
        makeCommit({
          message: "feat: improve parser\n\nCo-Authored-By: Pi <noreply@pi.dev>",
        })
      );
      expect(result.classification).toBe("ai-assisted");
    });
  ...
  describe("Level 6: Commit message AI markers", () => {
    ...
    it('classifies "Generated-By: pi 0.52.12" as ai-assisted', () => {
      const result = classifyCommit(
        makeCommit({
...
describe("hasAiCoAuthor", () => {
  ...
  it("returns true for Pi co-author", () => {
    expect(hasAiCoAuthor(["Pi <noreply@pi.dev>"])).toBe(true);
  });
...
describe("classifyAiCoAuthor", () => {
  ...
  it("identifies Pi co-author as ai-assisted", () => {
    expect(classifyAiCoAuthor(["Pi <noreply@pi.dev>"])).toBe("ai-assisted");
  });
});
...
describe("classifyAiMessageMarker", () => {
  ...
  it("identifies Pi marker from message", () => {
    expect(classifyAiMessageMarker("Generated-By: pi 0.52.12")).toBe("ai-assisted");
  });
...
describe("hasAiMessageMarker", () => {
  ...
  it("detects Generated-By: pi marker", () => {
    expect(hasAiMessageMarker("fix: test\n\nGenerated-By: pi 0.52.12")).toBe(true);
  });
